...
const customDarkTheme = {
  ...
  colors: {
    surface: '#121212', //元件預設色

    background: '#121212', // 背景顏色(v-main)

    ...vars,

    // 專案顏色 | Project Color
    'primary-color': vars['theme-color-teal-dark'], // 主要顏色
    'primary-color-dark': vars['theme-color-teal-dark'], // 加深變體
    'primary-color-tint': vars['theme-color-teal-tint'], // 淺色變體
    'primary-color-bg': '#f0f4f9', // 背景色

    'secondary-color': vars['theme-color-blue'], // 次要顏色
    'secondary-color-dark': vars['theme-color-blue-dark'], // 加深變體
    'secondary-color-tint': vars['theme-color-blue-tint'], // 淺色變體
    ...
    'table-header': vars['theme-color-teal-dark'],
    'table-row-color': vars['black-tone-90'],
    'table-header-text': vars['white'],
    'table-content-text': vars['black-tone-10'],

    'label-color': vars['black-tone-80'],

    // 按鈕 Button
    'primary-button-default': vars['theme-color-teal'],
    'primary-button-hover': vars['theme-color-teal-dark'],
    'primary-button-text': vars['white'],

    'secondary-button-default': vars['theme-color-blue'],
    'secondary-button-hover': vars['theme-color-blue-dark'],
